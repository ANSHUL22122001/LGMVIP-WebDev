...
?>
    ...
    $user_Login_query = "select * from faculity";            
    $user_Login_submit = mysqli_query($con, $user_Login_query);
    $faculity = mysqli_num_rows($user_Login_submit);
    
    $user_Login_query = "select * from student";            
    $user_Login_submit = mysqli_query($con, $user_Login_query);
    $student = mysqli_num_rows($user_Login_submit);
    
    $user_Login_query = "select * from class";            
    $user_Login_submit = mysqli_query($con, $user_Login_query);
    $class = mysqli_num_rows($user_Login_submit);
    
    $user_Login_query = "select * from exam";            
    $user_Login_submit = mysqli_query($con, $user_Login_query);
    $exam = mysqli_num_rows($user_Login_submit);
    
    $user_Login_query = "select * from exam where resultPublish='Yes'";            
    $user_Login_submit = mysqli_query($con, $user_Login_query);
